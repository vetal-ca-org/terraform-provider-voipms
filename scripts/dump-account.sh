...
jq '{
  ...
  voicemails: [.voicemails.voicemails[]? | {mailbox, name, email, timezone, transcription}],
  ...
  ring_groups: [.ring_groups.ring_groups[]? | {ring_group, name, members, voicemail}],
  time_conditions: [.time_conditions.timecondition[]? | {timecondition, name, routing_match, routing_nomatch}],
  recordings: [.recordings.recordings[]? | {value, description}],
  unconfigured: {
    ivrs: .ivrs.status,
